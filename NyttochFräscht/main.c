...
void initiatePorts(){
	//Initierar PORTE som INPUT för LEDs och den analoga inputen A2.
	TRISE = 0xfff8;
	//TRISESET = 0xfff8;
...
void displayWelcome(){
	...
	display_init();
	display_string(0, "Massa test");
	display_string(1, "Wine is good");
	display_string(2, "Heja Gnaget");
...
int main() {
	...
	while(1){
		...
		display_string(3, itoaconv(humidity()));
		display_update();
		derp++;
		//humidity();
		//checkTime();
